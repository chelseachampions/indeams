...
function FeaturesHome1() {
  ...
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 mb-16 pointer-events-none" aria-hidden="true"></div>
      <div className="absolute left-0 right-0 w-px h-20 p-px m-auto transform -translate-y-1/2 "></div>
