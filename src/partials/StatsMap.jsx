      ...
      <div className="max-w-6xl px-4 mx-auto sm:px-6">
        <div className="py-12 border-t border-gray-200 md:py-20">
          ...
          <div className="max-w-3xl pb-12 mx-auto text-center md:pb-16">
            <h1 className="mb-4 h2">Developing a global mindset</h1>
          ...
          <div className="flex flex-col items-center pt-16 pb-12 md:pt-20 md:pb-16">
            <div className="relative">
              {/* Halo effect */}
              <svg className="absolute inset-0 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none left-1/2 top-1/2" width="800" height="800" viewBox="0 0 800 800" style={{ maxWidth: '200%' }} xmlns="http://www.w3.org/2000/svg">
              ...
              <svg className="absolute w-32 h-auto rounded-full shadow-xl" viewBox="0 0 128 48" style={{ width: '32%', top: '20%', right: '-16%' }} xmlns="http://www.w3.org/2000/svg">
                <rect className="text-white fill-current" width="128" height="48" rx="24" />
              </svg>
              {/* Globe image */}
              ...
              {/* Avatars */}
              <img className="absolute max-w-full transform animate-float" src={require('../images/planet-avatar-03.png').default} width="287" height="86" alt="Planet avatar 03" style={{ width: '71.75%', top: '-4%', left: '-23.5%' }} />
              <img className="absolute max-w-full transform animate-float animation-delay-1000" src={require('../images/planet-avatar-04.png').default} width="256" height="126" alt="Planet avatar 04" style={{ width: '64%', bottom: '2%', right: '-18%' }} />
              <img className="absolute max-w-full transform animate-float animation-delay-1000" src={require('../images/planet-avatar-05.png').default} width="296" height="78" alt="Planet avatar 05" style={{ width: '74%', top: '-5%', right: '-22%' }} />
              {/* White box */}
              ...
              {/* Blue icon */}
              <svg className="absolute w-16 h-auto max-w-full rounded-full shadow-xl" viewBox="0 0 64 64" style={{ width: '16%', top: '7%', right: '-12%' }} xmlns="http://www.w3.org/2000/svg">
                <circle className="text-blue-600 fill-current" cx="32" cy="32" r="32" />
                <path className="text-white fill-current" d="M35.233 22L32 27.6 28.766 22H18l14 24.25L46 22z" />
                <path className="text-blue-300 fill-current" d="M35.233 22L32 27.6 28.766 22H23.6L32 36.548 40.4 22z" />
              </svg>
              {/* Black icon */}
              <svg className="absolute w-16 h-auto max-w-full rounded-full shadow-xl" viewBox="0 0 64 64" style={{ width: '16%', bottom: '12%', left: '-17%' }} xmlns="http://www.w3.org/2000/svg">
                <circle className="text-gray-800 fill-current" cx="32" cy="32" r="32" />
                <g transform="translate(.582 .055)" fill="none" fillRule="evenodd">
                  <g transform="rotate(45 -6.35 52.885)">
                    <path className="text-gray-300 fill-current" d="M5-1h2v7H5zM5 16h2v7H5z" />
                    <circle className="text-white stroke-current" strokeWidth="2" strokeLinecap="square" cx="6" cy="11" r="6" />
                  </g>
                </g>
              </svg>
            </div>
          ...
          {/* Items */}
          <div className="grid items-start max-w-sm gap-8 pt-8 mx-auto md:gap-16 md:grid-cols-2 lg:grid-cols-3 md:max-w-2xl lg:max-w-5xl md:pt-12">


            {/* 1st item */}
            <div className="text-center">
              <div className="mb-1 h3">2012</div>
              <div className="text-gray-600">Lorem ipsum is placeholder text commonly used tristique senectus et netus.</div>
            </div>

            {/* 2nd item */}
            <div className="text-center">
              <div className="mb-1 h3">$20M</div>
              <div className="text-gray-600">Lorem ipsum is placeholder text commonly used tristique senectus et netus.</div>
            </div>

            {/* 3rd item */}
            <div className="text-center">
              <div className="mb-1 h3">250M+</div>
              <div className="text-gray-600">Lorem ipsum is placeholder text commonly used tristique senectus et netus.</div>
            </div>

            {/* 4th item */}
            <div className="text-center">
              <div className="mb-1 h3">2700+</div>
              <div className="text-gray-600">Lorem ipsum is placeholder text commonly used tristique senectus et netus.</div>
            </div>

            {/* 5th item */}
            <div className="text-center">
              <div className="mb-1 h3">400K</div>
              <div className="text-gray-600">Lorem ipsum is placeholder text commonly used tristique senectus et netus.</div>
            </div>

            {/* 6th item */}
            <div className="text-center">
              <div className="mb-1 h3">Millions</div>
              <div className="text-gray-600">Lorem ipsum is placeholder text commonly used tristique senectus et netus.</div>
            </div>
