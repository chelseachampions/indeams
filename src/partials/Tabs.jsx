...
import TabsImage01 from '../images/cyp-therapy-session.jpg';
  ...
  return (
    <section>
      <div className="max-w-6xl px-4 mx-auto sm:px-6">
        <div className="py-12 border-t border-purple-600 md:py-20">
          ...
          <div>
            ...
            <div className="flex flex-wrap justify-center -m-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-tabs]">
              <button
                ...
                onClick={() => setTab(1)}
              >
                <svg className="w-4 h-4 mr-2 text-purple-600 fill-current" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-gray-400 transition-colors duration-150 ease-in-out group-hover:text-gray-200">Scalable</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 transition-colors duration-150 ease-in-out group-hover:text-gray-200">Built for a 2022 audience</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 transition-colors duration-150 ease-in-out group-hover:text-gray-200">Quick action</span>
              </button>
              <button
            ...
            <div className="relative flex flex-col mt-16" data-aos="fade-up" ref={tabs}>
              ...
              >
                <article className="relative max-w-md mx-auto md:max-w-none">
                  <figure className="md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                    <img className="object-cover w-full h-full" src={TabsImage01} width="516" height="387" alt="Tabs 01" />
                  </figure>
                  <div className="relative px-6 py-8 bg-gray-800 md:py-16 md:pr-16 md:max-w-lg lg:max-w-xl">
                    <h4 className="mb-2 h4">Current Problem</h4>
                    <p className="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                    <a className="mt-6 text-white bg-purple-600 btn-sm hover:bg-purple-700" href="#0">
                      <span className="text-sm">Learn more</span>
                      <svg className="w-3 h-3 ml-2 text-purple-400 fill-current shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <article className="relative max-w-md mx-auto md:max-w-none">
                  <figure className="md:absolute md:inset-y-0 md:left-0 md:w-1/2">
                    <img className="object-cover w-full h-full" src={HeroImage01} width="516" height="387" alt="Tabs 02" />
                  </figure>
                  <div className="relative px-6 py-8 bg-gray-800 md:py-16 md:pl-16 md:max-w-lg lg:max-w-xl md:ml-auto">
                    <h4 className="mb-2 h4">Easy to start, optimize and scale</h4>
                    <p className="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                    <a className="mt-6 text-white bg-purple-600 btn-sm hover:bg-purple-700" href="#0">
                      <span className="text-sm">Learn more</span>
                      <svg className="w-3 h-3 ml-2 text-purple-400 fill-current shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <article className="relative max-w-md mx-auto md:max-w-none">
                  ...
                  <div className="relative px-6 py-8 bg-gray-800 md:py-16 md:pr-16 md:max-w-lg lg:max-w-xl">
                    <h4 className="mb-2 h4">Optimize and scale, easy to start</h4>
                    <p className="text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                    <a className="mt-6 text-white bg-purple-600 btn-sm hover:bg-purple-700" href="#0">
                      <span className="text-sm">Learn more</span>
                      <svg className="w-3 h-3 ml-2 text-purple-400 fill-current shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
