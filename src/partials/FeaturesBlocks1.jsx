    ...
    <section>
      <div className="max-w-6xl px-4 mx-auto sm:px-6">
        <div className="py-12 border-t border-gray-200 md:py-20 dark:border-gray-800">
          ...
          {/* Items */}
          <div className="grid max-w-xs gap-4 mx-auto sm:max-w-none md:max-w-xl lg:max-w-none sm:grid-cols-2 lg:gap-6 lg:grid-cols-4" data-aos-id-featbl>

            {/* 1st item */}
            <a className="flex flex-col p-5 text-white shadow-2xl group bg-gradient-to-tr from-teal-500 to-teal-400 dark:to-teal-500" href="#0" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]">
              ...
              <div className="mb-1 text-xl font-extrabold tracking-tighter font-red-hat-display">497,502</div>
              <div className="flex-grow mb-4 opacity-80">No. of children referred to NHS children’s mental health services (20/21).</div>
              <svg className="self-end w-6 h-6 transition duration-150 ease-in-out transform -translate-x-2 group-hover:translate-x-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path className="fill-current" d="M13 11V5.057L22.72 12 13 18.943V13H2v-2h11zm2 4.057L19.28 12 15 8.943v6.114z" />
              </svg>
            </a>

            {/* 2nd item */}
            <a className="flex flex-col p-5 text-white shadow-2xl group bg-gradient-to-tr from-purple-500 to-purple-400 dark:to-purple-500" href="#0" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]" data-aos-delay="100">
              <svg className="w-8 h-8 mb-3" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="mb-1 text-xl font-extrabold tracking-tighter font-red-hat-display">£881 million</div>
              <div className="flex-grow mb-4 opacity-80">Spending on specialist NHS mental health services for CYP's (20/21).</div>
              <svg className="self-end w-6 h-6 transition duration-150 ease-in-out transform -translate-x-2 group-hover:translate-x-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path className="fill-current" d="M13 11V5.057L22.72 12 13 18.943V13H2v-2h11zm2 4.057L19.28 12 15 8.943v6.114z" />
              </svg>
            </a>
            ...
            {/* 3rd item */}
            <a className="flex flex-col p-5 text-white shadow-2xl group bg-gradient-to-tr from-indigo-500 to-indigo-400 dark:to-indigo-500" href="#0" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]" data-aos-delay="200">
              <svg className="w-8 h-8 mb-3" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="mb-1 text-xl font-extrabold tracking-tighter font-red-hat-display">1 in 6</div>
              <div className="flex-grow mb-4 opacity-80">Have a probable mental health disorder. Up from 1 in 9 in 2017 (20/21)</div>
              <svg className="self-end w-6 h-6 transition duration-150 ease-in-out transform -translate-x-2 group-hover:translate-x-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path className="fill-current" d="M13 11V5.057L22.72 12 13 18.943V13H2v-2h11zm2 4.057L19.28 12 15 8.943v6.114z" />
              </svg>
            </a>
            ...
            {/* 4th item */}
            <a className="flex flex-col p-5 text-white shadow-2xl group bg-gradient-to-tr from-pink-500 to-pink-400 dark:to-pink-500" href="#0" data-aos="fade-down" data-aos-anchor="[data-aos-id-featbl]" data-aos-delay="300">
              <svg className="w-8 h-8 mb-3" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="mb-1 text-xl font-extrabold tracking-tighter font-red-hat-display">32 Days</div>
              <div className="flex-grow mb-4 opacity-80">Average waiting time once accepted into mental health treatment services. (20/21)</div>
              <svg className="self-end w-6 h-6 transition duration-150 ease-in-out transform -translate-x-2 group-hover:translate-x-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path className="fill-current" d="M13 11V5.057L22.72 12 13 18.943V13H2v-2h11zm2 4.057L19.28 12 15 8.943v6.114z" />
              </svg>
            </a>
...
export default FeaturesBlocks1;
